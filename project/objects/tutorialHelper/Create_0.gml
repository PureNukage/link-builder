...
if os_browser != browser_not_a_browser {
	...
	script[# tut, index] = "To build Decentralized Applications, 3 things will be needed: Data, Nodes and Contracts" index++
	...
	script[# tut, index] = "A Node has been placed. Press the Wire button to place down a wire and then connect the Data to the Node" index++
	...
	script[# tut, index] = "Luckily for us we have a Node connected to Binance's ETH/USD API" index++
	script[# tut, index] = "Lets go ahead and connect the Node to the Price Feed Contract now" index++
	...
	script[# tut, index] = "In Smart Contract Builder this is known as a Node" index++
	script[# tut, index] = "To get the LinkPal Contract online you will have to use 2 Nodes" index++
	...
	script[# tut, index] = "Remember! Data has to pass through a Node first" index++
	...
	script[# tut, index] = "When Jane sees that Bob has $100 of ETH, Jane will pay $100 to the Invoice, the Node will see and release the $100 ETH to Jane" index++
	script[# tut, index] = "This means it is very important that the LinkPal Contract is able to know the price of ETH. If the wrong price of ETH was used Jane could end up receiving more or less than $100. That's not good!" index++
	...
	script[# tut, index] = "You've been given 3 sources of ETH/USD to place and the Node has been given two more Ports" index++

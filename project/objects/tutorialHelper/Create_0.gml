...
if os_browser != browser_not_a_browser {
	...
	script[# tut, index] = "Items in placement can be rotated by pressing Q or E" index++
	script[# tut, index] = "Rotate the data now" index++
	script[# tut, index] = "Place the data source somewhere into the level" index++
	script[# tut, index] = "Items can be re-placed by selecting it and pressing R" index++
	...
	script[# tut, index] = "We can see that this Contract requires an ETH/USD Data source" index++

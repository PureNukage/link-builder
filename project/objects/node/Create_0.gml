...
ports[0,port_x] = bottomright_cell_x
ports[0,port_y] = center_cell_x

ports[1,port_x] = center_cell_x
ports[1,port_y] = bottomright_cell_y

ports[2,port_x] = topleft_cell_x
ports[2,port_y] = center_cell_y

ports[3,port_x] = center_cell_x
ports[3,port_y] = topleft_cell_y
#endregion
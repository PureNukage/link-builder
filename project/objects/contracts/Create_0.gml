...
create_contract("Eth Transfer","",100,150,s_portrait_ethereum,2,10,5,contract_types.people,levels,_data,true)
...
create_contract("LinkPal",_string,200,500,s_portrait_linkpal,2,10,5,contract_types.people,levels,_data,true)
...
create_contract("BountiBot",_string,300,2000,s_portrait_bountibot,2,10,5,contract_types.people,levels,_data,true)

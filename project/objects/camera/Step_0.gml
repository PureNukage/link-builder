	...
	case camera_mode.free:
		...
		#region Zooming Up and Down
			...
			if instance_exists(shop) and instance_exists(contracts) and instance_exists(textboxController) {
				if !topmenu.data_mouseover and !topmenu.node_mouseover and !contracts.menu_mouseover and !shop.link_mouseover and !shop.eth_mouseover and !textboxController.messages_mouseover {

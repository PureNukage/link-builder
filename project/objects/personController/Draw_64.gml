...
if new_hero > 0 {
	...
	if button_glow {
		button_color = merge_color(button_color,button_color_1,lerp_amount)
		if button_timer >= 0 button_timer--
		else {
			button_timer = button_timer_flip
			button_glow = false
		}
	}
	else {
		button_color = merge_color(button_color,button_color_0,lerp_amount)
		if button_timer >= 0 button_timer--
		else {
			button_timer = button_timer_flip
			button_glow = true

...
public class GameAnalyticsExt
{
    ...
    public void addBusinessEventJson(String json)
    {
        ...
        {
            JSONArray jsonArray = new JSONArray(json);
            GameAnalytics.addBusinessEventWithCurrency(jsonArray.getString(0), jsonArray.getInt(1), jsonArray.getString(2), jsonArray.getString(3), jsonArray.getString(4));
        }
        catch (JSONException e)
        {
        }
    ...
    public void addResourceEventJson(String json)
    {
        ...
        {
            JSONArray jsonArray = new JSONArray(json);
            GameAnalytics.addResourceEventWithFlowType(jsonArray.getInt(0), jsonArray.getString(1), (float)jsonArray.getDouble(2), jsonArray.getString(3), jsonArray.getString(4));
        }
        catch (JSONException e)
        {
        }
    ...
    public void addProgressionEventWithScoreJson(String json)
    {
        ...
        {
            JSONArray jsonArray = new JSONArray(json);
            GameAnalytics.addProgressionEventWithProgressionStatus(jsonArray.getInt(0), jsonArray.getString(1), jsonArray.getString(2), jsonArray.getString(3), jsonArray.getDouble(4));
        }
        catch (JSONException e)
        {
        }

...
if argument_count >= 6 var _node_available = argument[5]
...
if argument_count >= 6 item_node[new_node, node_available] = _node_available else item_node[new_node, node_available] = false

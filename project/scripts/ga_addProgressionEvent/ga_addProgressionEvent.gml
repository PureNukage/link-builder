...
if(argument_count == 2)
{
	if(os_browser == browser_not_a_browser)
	{
		...
		{
			addProgressionEvent_mac(status, argument[1], "", "");
		}
		else if(os_type == os_linux)
		{
			addProgressionEvent_linux(status, argument[1], "", "");
		}
		else if(os_type == os_uwp)
		{
			addProgressionEvent_uwp(status, argument[1], "", "");
		}
	}
	else
	{
...
else if(argument_count == 3)
{
    ...
    else
    {
		if(os_browser == browser_not_a_browser)
		{
			...
			{
				addProgressionEvent_mac(status, argument[1], argument[2], "");
			}
			else if(os_type == os_linux)
			{
				addProgressionEvent_linux(status, argument[1], argument[2], "");
			}
			else if(os_type == os_uwp)
			{
				addProgressionEvent_uwp(status, argument[1], argument[2], "");
			}
		}
		else
		{
...
else if(argument_count == 4)
{
    ...
    else
    {
		if(os_browser == browser_not_a_browser)
		{
			...
			{
				addProgressionEvent_mac(status, argument[1], argument[2], argument[3]);
			}
			else if(os_type == os_linux)
			{
				addProgressionEvent_linux(status, argument[1], argument[2], argument[3]);
			}
			else if(os_type == os_uwp)
			{
				addProgressionEvent_uwp(status, argument[1], argument[2], argument[3]);
			}
		}
		else
		{
